...
import { CheckCircle, Loader2Icon, XCircleIcon } from "lucide-react";
...
export function BaseNode({ className, status, ...props }: BaseNodeProps) {
  return (
    <div
      className={cn(
        "bg-card text-card-foreground relative rounded-md border border-muted-foreground hover:bg-accent",
        "hover:ring-1",
        className,
      )}
      tabIndex={0}
